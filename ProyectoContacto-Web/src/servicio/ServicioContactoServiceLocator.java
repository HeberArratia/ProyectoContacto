...
public class ServicioContactoServiceLocator extends org.apache.axis.client.Service implements servicio.ServicioContactoService {
    ...
    private java.lang.String ServicioContacto_address = "http://localhost:8080/ProyectoContacto-ServicioWeb/services/ServicioContacto";
    ...
    public servicio.ServicioContacto getServicioContacto() throws javax.xml.rpc.ServiceException {
    ...
    public servicio.ServicioContacto getServicioContacto(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            servicio.ServicioContactoSoapBindingStub _stub = new servicio.ServicioContactoSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (servicio.ServicioContacto.class.isAssignableFrom(serviceEndpointInterface)) {
                servicio.ServicioContactoSoapBindingStub _stub = new servicio.ServicioContactoSoapBindingStub(new java.net.URL(ServicioContacto_address), this);
                _stub.setPortName(getServicioContactoWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://servicio", "ServicioContactoService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://servicio", "ServicioContacto"));
        }
